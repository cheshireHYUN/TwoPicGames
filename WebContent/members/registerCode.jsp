							...
							<div class="css-r7crhi">
								...
								<div class="css-qxp7yl">
									<%
										if (msg != null) {
									%>
									<img width="180" height="260" src="<%=gameVO.getGame_img()%>"
										class="css-doi34z"
							...
							<aside class="css-8f26af">
								...
								<span class="css-11ksoqt">
									<div class="css-8nuajj">
										<span data-component="Message">DVD와 함께 제공된 제품 코드 또는 기타
											에픽게임즈 제품 코드를 입력하세요.</span>
									</div>
								</span>
								<!-- 코드 번호를 입력해서 전송하는 form -->
								<form class="css-1adx308" action="/members/registerCode.do"
									method="post">
									<label class="css-1d3w5wq" for="code"><input
										type="text" autocomplete="off" spellcheck="false" name="code"
										id="code" value="" class="css-34tx6k" maxlength="23"
										placeholder="00000-00000-00000-00000" required=""><span
										class="css-1qwdmuy">제품 등록</span></label>
								...
								%>
								<h5 class="css-1ifcw8j">
									<span>제품을 성공적으로 등록했습니다!</span>
								</h5>
								<%
									} else if (msg.equals("noGameCode")) {
								%>
								<h5 class="css-1ifcw8j">
									<span>해당 게임의 코드가 올바르지 않습니다.</span>
								</h5>
								<%
									} else if (msg.equals("existGame")) {
								%>
								<h5 class="css-1ifcw8j">
									<span>해당 게임에 대한 구매기록이 있어 사용이 불가능합니다.</span>
								</h5>
								<%
									}
								}
