																	...
																	<div class="css-yb58t8">
																		<div class="css-han5dv">
																			<img class="css-11h61hf" alt=""
																				...
																				data-image="<%=gameInfoList.get(i).getGame_img() %>"
																		...
																		<%
																			...
																			%>		
																					...
																					<div class="css-l24hbj">
																						...
																						<div class="css-l24hbj">
																							<span class="css-z3vg5b">무료</span>
																						</div></span>
																					</div>
																					
			 																		<div class="css-hkh81z">
																						<span class="css-iqno47">
																						<span><%=vo.getFgm_fdt() %> 까지 할인 </span></span>
																					</div>
																			<%
																					} else{
																	...
																	<div class="css-vs1xw0">
																		<div class="css-7whenc">
																			<div class="css-1f1kwdk">
																					...
																					<%	
																						String srcImg ="";
																						String age = gameInfoList.get(i).getAge();
																						if(age.equals("전체이용가")){
...
<!-- 																		<button class="css-1yu35vh">
																		...
																		<div class="css-tg7p45">
																			<button class="css-1yu35vh"
																			onClick="location.href='deleteCart.do?gameId=<%=selectGameList.get(i) %>'"
																			>
																				<div class="css-s5xdrg">
																					<span class="css-z3vg5b">
										...
										<%	
											...
											// freeGame 가격을 토탈에서 도로 빼버리자
											totalPrice += Integer.parseInt((gameInfoList.get(i).getGame_price()));
										...
										<div class="css-1fttcpj">
											...
											<div class="css-sdue89">
												<div class="css-1eoy87d">
													...
													int salePrice =0;
													for(FreeGameVO vo : freeGameList){
														System.out.println("cartDetail jsp에서 총 게임가격계산!!! 0원이되는 게임 가격 : "+vo.getGame_price());
														salePrice += vo.getGame_price();
													}
													%>
											...
											<div class="css-1fkya4n">
												<button class="css-20a60t" data-toggle="modal" data-target="#reviewModal" aria-disabled="false"
												onclick ="location.href='../orderController.do?totalPrice=<%=totalPrice %>'">
													<span>구매하기</span>
												</button>
											</div>
										</div>
