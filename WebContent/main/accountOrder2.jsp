			...
			<div class="col-lg-3 col-md-3 col-sm-3 sidebar-section hidden-xs">
				<div class="container sidebar-container">
					<div class="navigation-section">
						...
						<!-- 주문 내역 확인 버튼 -->
						<button class="setting col-sm-12 col-md-12 password active " id = "memberOrder">
							거래<i class="glyphicon glyphicon glyphicon-menu-right pull-right visible-xs custom-chevron"></i>
						</button>
						<!-- 비밀번호 변경 버튼 -->
						<button class="setting col-sm-12 col-md-12 transaction-history" id = "changePw">
												...
												<table class="table payment-history-table">
													...
													<thead>
														<tr>
															...
															<th class="table-header"><button class="sort-btn">게임 이름</button></th>
															<input type="hidden" name="gameId" value="<%=vo.get(i).getGameId() %>">
					...
					<div class="modal-dialog" style="margin-top:150px" role="document">
						<div class="modal-content rounded-4 shadow">
							<div class="modal-body p-5">
								...
								<form action="/members/insertReview.do" method="post" enctype="multipart/form-data">
									<ul class="d-grid gap-4 my-5 list-unstyled">
										<li class="d-flex gap-4">
											<div class="star-rating space-x-4 mx-auto">
												...
												<label for="3-stars" class="star">★</label> <input
													type="radio" id="2-stars" name="R" value="2"
										...
										<li class="d-flex gap-4">
											<div class="form-group">
												<input class="border-0 form-control" type="text" id="rev_tit"
										...
										<li class="d-flex gap-4">
											<div class="form-group">
												<input class="border-0 form-control" name="rev_con" id="rev_con"
													placeholder="내용"
