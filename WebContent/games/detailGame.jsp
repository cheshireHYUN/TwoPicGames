...
String gameId = detailList.get(0).getGame_id();
String gameName = detailList.get(0).getGame_name();
String gamePrice = detailList.get(0).getGame_price();
String gameDt = detailList.get(0).getRel_dt();
String age = detailList.get(0).getAge();
String gameDev = detailList.get(0).getGame_dev();
String gamePub = detailList.get(0).getPub_name();
String gameImg = detailList.get(0).getGame_img();
String gameTrailer = detailList.get(0).getGame_trailer();
																			...
																			<div class="css-r53zlq">
																				<div class="css-122y91a"
																					...
																					<video width="560" height="315" controls="controls"
																						...
																						autoplay="autoplay">
																						<source
																							src="<%=request.getContextPath()%>/movie/videoView.do?filename=<%=gameTrailer%>"
																							type="video/webm" autofocus="autofocus">
																					</video>
																					<%
																						} else {
																					%>
																					<video width="560" height="315" controls="controls"
																						class="css-yxalrd" preload="auto"
																						autoplay="autoplay" src="<%=gameTrailer%>"
																						autofocus="autofocus">
																					</video>
																					<%
																						}
											...
											<div class="css-1fttcpj">
												<div class="css-7q6jfy" data-component="AboutSectionLayout">
													<span class="css-1onp491" data-component="Text"><div
															...
															<div class="css-1myreog">무진장 많은 총기와 정신 없는 모험으로 가득한
																오리지널 슈팅 파밍 게임이 돌아왔습니다! 신세계와 적들 사이를 용감하게 뚫고 나가 은하계 내에서
																자비심 없기로 둘째가라면 서러운 사이비 교주로부터 고향을 지켜야 합니다.</div>
														</div></span>
												</div>
																...
																<div class="css-1pj7rfu">
																	<ul class="css-vs1xw0" data-component="MetadataList">
																		<%
																			...
																			if (detailList.get(i).getCom_name().equals("장르")) {
																		%>
																		<li class="css-t8k7" data-testid="metadata-list-1인칭"
																			data-component="MetadataList"><a
																			class="css-1672chc" role="link"
																			href="/Game.do?detail_name=<%=detailList.get(i).getDetail_name()%>"><span
																				class="css-z3vg5b" data-component="Text"><span
																					data-component="Message"><%=detailList.get(i).getDetail_name()%></span></span></a></li>
																		<%
																			}
																		}
																		%>
																...
																<div class="css-1pj7rfu">
																	<ul class="css-vs1xw0" data-component="MetadataList">
																		...
																		<li class="css-t8k7"
																			...
																			data-component="MetadataList"><a
																			class="css-1672chc" role="link"
																			href="/ko/browse?tag=컨트롤러 지원"><span
																				class="css-z3vg5b" data-component="Text"><span
																					data-component="Message"><%=detailList.get(i).getDetail_name()%></span></span></a></li>
																		<%
																			}
								...
								<aside class="css-566nsd">
									<div class="css-1gmuxco" data-component="DesktopSticky">
										<div class="css-1fttcpj" data-component="PDPSidebarLayout">
												...
												<div class="css-169q7x3"
													...
													<div class="css-fhxb3m" data-component="PriceLayout">
														<%
															...
															if (gameId.equals(freeList.get(i).getGame_id())) {
														%>
											...
											<div class="css-15fg505">
												<div class="css-1146xy9">
													<span class="css-iqno47" data-component="Text"><span
														data-component="Message"><%=freeList.get(i).getFgm_fdt()%>
															할인 종료</span></span>
												</div>
											</div>
											<%
											...
											<%
												// memId와 gameId에 해당하는 cartNo 가져오고 그게 order테이블에 있으면 바로결제가 아니라 이미 구매한 게임이라고 띄우기
												
												if (orderedGameIdList.isEmpty()==false) {
													for(String str : orderedGameIdList){
											...
											<div class="css-421tyv">
												<div class="css-1vncc1c"
													...
													%>
													<div class="css-8rk9sy">
														<img alt="전체이용가" class="css-7i9tj1" src="<%=ageAll%>"
															data-component="PDPRatingImage">
													</div>
													<div class="css-trn5ka">
														<div class="css-1d3w5wq">
														...
														<div class="css-fxdlmq"
															...
															<div class="css-btns76">
																<span class="css-z3vg5b" data-component="Text"><time
																		datetime="2019-09-13T15:00:00.000Z"
																		data-component="Time"><%=detailList.get(0).getRel_dt()%></time></span>
															</div>
														</div>
													</div>
													<div class="css-10mlqmn"
																...
																<div class="css-1biwmls"
																	...
																	<ul class="css-e6kwg0"
																		...
																		<li class="css-1nau1p3"
																			...
																			class="css-1qwdmuy" data-component="Icon"><%=detailList.get(detailList.size() - 1).getDetail_name()%></span></li>
																		<li class="css-1nau1p3"
													...
													<div class="css-5q96rd">
														<ul class="css-1qfz72n"
																	...
																	<%
																		if (reviewList.size() > 0) {
																			...
																			for (int i = 0; i < reviewList.size(); i++) {
																				sumgrd = reviewList.get(i).getRev_grd();
															...
															<li class="css-fuc5di" style="margin-left: 50px"><a
																href="https://redirect.epicgames.com/?redirectTo=https%3A%2F%2Fopencritic.com%2Fgame%2F7656%2Fborderlands-3"
																role="link" rel="noopener external" target="_blank"
																referrerpolicy="unsafe-url" data-component="Link"><span
																	class="css-dcpx1m" data-component="Text"><div
																			class="css-125og8r"
																			data-component="PDPCriticReviewMetrics">
																			<span data-component="Message">모든 리뷰 보기</span><span
																			...
																			<div
																				...
																				<div class="css-1k6yg9d"
																					...
																					<%
																						...
																						for (int i = 0; i < reviewList.size(); i++) {
																					%>
																					<div class="css-174xcl1" data-component="Level" style="margin-right: 20px">
																						<div class="css-13ku56z" style="width:280px">
																							<div class="css-1azpx8r">
																								<div class="css-1d3w5wq">
																									<span class="css-z3vg5b" data-component="Text"><%=reviewList.get(i).getRev_tit()%></span>
																								</div>
																								<div class="css-1d3w5wq">
																									<span class="css-11ksoqt" data-component="Text"><span
																										data-component="Message">작성자: <%=reviewList.get(i).getMem_id()%></span></span>
																								</div>
																							</div>
																							...
																							<div class="css-wt3lag" style="width:100%;">
																								<div class="css-1d3w5wq">
																									<%
																									String grdd = reviewList.get(i).getRev_grd();
																								...
																								<div class="css-uy4qy4">
																									<span class="css-11ksoqt" data-component="Text">“<%=reviewList.get(i).getRev_con()%>”
																									</span>
																								</div>
																							</div>
																						</div>
