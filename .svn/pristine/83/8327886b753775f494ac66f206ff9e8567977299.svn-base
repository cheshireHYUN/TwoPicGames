					...
					<div class="css-bjn8wh">
						<section class="css-17x0yd4">
							<div class="css-yewo14">
										...
										<div>
											...
											<div>
												<div class="css-zeyowa">
													<span class="css-lskqd4">김씽꾸</span>
												</div>
											</div>
														...
														<div>
															<div class="css-5kov97">
																...
																<div class="css-3hjqbx">
																	<div>
																		<span class="css-25dfdw"> <span>총 획득 XP</span></span>
																...
																<div class="css-3hjqbx">
																	<div>
																		<span class="css-25dfdw"> <span>등급</span></span>
																		<!-- 등급 아이콘 출력 영역 -->
																		<div class="css-tnyvi7">
																			<span class="css-4xt872" aria-hidden="true"> <svg
																					xmlns="http://www.w3.org/2000/svg"
								...
								<div>
									<!-- 업적 출력 화면 -->
									<div class="css-uejgfo">
										<div class="css-13efb1d" role="button" tabindex="0">
											<span>업적</span>
										</div>
									</div>
									<div class="css-bjn8wh">
										<div>
																...
																<div class="css-1azpx8r">
																	<div class="css-13ku56z">
																		<div class="css-f0xnhl">
																			<div class="css-1lozana"
																				...
																				<div data-testid="picture" data-component="Picture">
																					<img alt="The Suicide of Rachel Foster"
																						src="https://cdn1.epicgames.com/spt-assets/13be2d108e0344c98158bf4a2926bba5/download-the-suicide-of-rachel-foster-offer-9a21t.jpg?h=854&amp;resize=1&amp;w=640"
																						class="css-doi34z"
																		...
																		<div class="css-hkjq8i">
																			<span class="css-2ucwu" data-component="OfferTitleInfo"><div
																					data-testid="direction-auto" class="css-1h2ruwl"
																					data-component="DirectionAuto">The Suicide of Rachel Foster</div></span>
																	</div>
																</div>
															</div>
														</div>
											...
											트로피 아이콘 영역 
												<span class="css-m0rox4" aria-hidden="true">
												<svg xmlns="http://www.w3.org/2000/svg" class="svg css-w1atjl"
														viewBox="0 0 80 76">
														<g opacity=".15">
														<path fill="#7B7B7B"
														...
														<stop stop-color="#fff"></stop>
														<stop offset=".709" stop-color="#fff" stop-opacity="0"></stop></linearGradient></defs></svg></span>
												<div>
													<div class="css-pr10xp">
														<span class="css-11ksoqt">
														<span>XP를 얻으면 업적이 여기에 표시됩니다.</span></span>
													</div>
													 메인 링크 걸어주기!!!!! 
													<a class="css-1rpsjh1" role="link" href="">
													<span>게임 찾아보기</span></a>
												</div> 
											</div> -->
										</div>
