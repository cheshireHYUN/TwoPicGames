...
public class DetailAnswerController extends HttpServlet  {
	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		AnswerVO vo = ansService.getAnswer(qesId);
		
		req.setAttribute("vo", vo);
		req.getRequestDispatcher("/notices/answer/detail.jsp").forward(req, resp);
	}
